...
@mcp.tool(
    ...
    description="Read the contents of a document and return it as string. The input is the doc name."
)
def read_document(
...
@mcp.tool(
    name ="edit_document",
    description="Edit a document by replacing its contents with new string."
)
def edit_document(
